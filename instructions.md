...
1. **setModel**
   ...
   - **Описание**: Поле settings позволяет безопасно изменить параметры model, temperature, top_p, presence_penalty модели. Поле extra опционально и позволяет настроить модель более тонко, а так же добавить фцнкции выполнения. [расширенное использование OpenAI API)]([https://developer.mozilla.org/en-US/docs/Web/JavaScript](https://platform.openai.com/docs/api-reference/chat/create#chat-create-tools))
